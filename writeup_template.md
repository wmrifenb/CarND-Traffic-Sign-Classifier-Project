...
The code for this step is contained in the fourth, fifth and sixth code cells of the IPython notebook.
...
As a last step, I attempted to normalize image data by converting the range of values from 0-255 to 0.0-1.0. This proved to hurt the convergence of the neural network so I abondoned it. 
